...
export function TextToImageForm({ userId }: TextToImageFormProps) {
        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                id="prompt"
                placeholder={getTranslation("mediaGeneration.textToImage.promptPlaceholder")}
                value={prompt}
            ...
            <Button onClick={handleGenerate} disabled={isGenerating || !prompt.trim()} className="w-full">
              {isGenerating ? (
                ...
                <T text="mediaGeneration.textToImage.generateButton" />
              )}
            </Button>
          </div>
        </CardContent>
              ...
              {isGenerating ? (
                <div className="flex flex-col items-center justify-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    <T text="mediaGeneration.textToImage.generatingImage" />
                  </p>
                </div>
              ) : result?.url ? (
                <div className="relative w-full h-full">
                  <img
                    ...
                    alt={result.prompt || getTranslation("mediaGeneration.generatedImage")}
                ...
                <div className="flex flex-col items-center justify-center">
                  <p className="text-sm text-muted-foreground">
                    <T text="mediaGeneration.textToImage.noImageYet" />
                  </p>
                </div>
              )}
            </div>
