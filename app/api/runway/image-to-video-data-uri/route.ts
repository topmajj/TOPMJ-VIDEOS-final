...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      console.log("Making Runway API request with data URI")
      ...
      const { data: insertData, error } = await supabase
        ...
        .insert({
          ...
          type: "video",
          prompt: promptText,
          input_image_url: "data-uri", // We don't store the data URI
          status: "processing",
    ...
    console.error("Error in image-to-video-data-uri route:", error)
